    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        @endcan
                        <a class="nav-link" href="{{url('transportasi')}}">
                            <i class="mdi mdi-bank menu-icon"></i>
                            <span class="menu-title">Transportasi</span>
                        </a>
                    </div>
                    <a href="{{url('pemesanan')}}" class="btn btn-primary rounded-pill py-2 px-4 ms-lg-4">
                        <i class="mdi mdi-bank menu-icon"></i>
                        <span class="menu-title">Pesan sekarang</span>
                    </a>
                </div>
            </nav>
        </div>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4">Selamat Datang</h1>
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="{{url('home')}}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{url('category')}}">Category</a></li>
                    <li class="breadcrumb-item"><a href="{{url('transportasi')}}">Taransportasi</a></li>
